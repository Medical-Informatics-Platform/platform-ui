...
describe('VariablesPanelComponent bubble selection', () => {
  ...
  it('expands and collapses the search bar', () => {
    const fixture = TestBed.createComponent(VariablesPanelComponent);
    const component = fixture.componentInstance;
  ...
  it('removes a specific variable from the pool when removeVariable is called', () => {
    const fixture = TestBed.createComponent(VariablesPanelComponent);
    const component = fixture.componentInstance;
    experimentStudioService.selectedVariables.set([
      { code: 'var1', label: 'Var 1' },
      { code: 'var2', label: 'Var 2' },
    ]);

    component.removeVariable({ code: 'var1', label: 'Var 1' });

    expect(experimentStudioService.setVariables).toHaveBeenCalledWith([{ code: 'var2', label: 'Var 2' }]);
  });

  it('clears all variables when clearAllVariables is called', () => {
    const fixture = TestBed.createComponent(VariablesPanelComponent);
    const component = fixture.componentInstance;
    experimentStudioService.selectedVariables.set([
      { code: 'var1', label: 'Var 1' },
