...
export const EXPERIMENT_STUDIO_GUIDE_STEPS: ExperimentStudioGuideStep[] = [
  ...
  },
  {
    ...
    body: 'Browse variables in <strong>Map</strong>, <strong>List</strong>, or <strong>Graph</strong> (switch modes anytime). Charts and details for the current selection appear on the right.',
  ...
  },
  {
    ...
    section: 'Analysis',
    title: 'Data Handling',
    body: 'Data Handling is optional: three stations (<strong>Filtering</strong>, <strong>Preprocessing</strong>, <strong>Transformation</strong>) plus a read-only <strong>Raw data</strong> preview. Solid cards are already in the run (<strong>Default</strong> or <strong>Applied</strong>); dashed cards are inactive. Use <strong>Preview data</strong> to inspect, <strong>Apply</strong>/<strong>Close</strong> to finish a station, then <strong>Continue to Algorithm Selection</strong> when ready — you can skip stations and keep the raw cohort.',
  ...
  },
  {
    ...
    section: 'Analysis',
    title: '1. Filtering',
    body: 'Optional: open <strong>Add Filtering</strong> to add filter rules. With no rules, <strong>Preview data</strong> still shows the raw cohort. Use <strong>Apply</strong> when you have conditions to commit — it saves and closes the editor. With none, the button reads <strong>Close</strong> and drops the empty step.',
  ...
  },
  {
    ...
    body: '<strong>Preview data</strong> shows the tables. Use <strong>Charts</strong> or <strong>Histogram</strong> for other views, then <strong>Close</strong> to return to the editor. Export PDF or CSV when you need a snapshot.',
  ...
  },
  {
    ...
    body: 'The result toolbar groups follow-ups. This tour uses <strong>Save as</strong> next; <strong>Edit parameters</strong> and <strong>Export PDF</strong> are available anytime on a result.',
