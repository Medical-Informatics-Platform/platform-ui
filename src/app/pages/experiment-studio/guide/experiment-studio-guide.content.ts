...
export const EXPERIMENT_STUDIO_GUIDE_STEPS: ExperimentStudioGuideStep[] = [
  ...
  },
  {
    ...
    section: 'Analysis',
    title: 'Data Handling',
    body: 'Data Handling has three optional stations: <strong>Add Filtering</strong>, <strong>Customize Preprocessing</strong>, and <strong>Add Transformation</strong>. Use <strong>Preview data</strong> inside a station to inspect tables and charts. <strong>Apply &amp; Continue</strong> only when you have pending edits; reopen a station with <strong>Edit filters</strong>, <strong>Edit preprocessing</strong>, or <strong>Edit transformation</strong>. When you are ready, use <strong>Continue to Algorithm Selection</strong> — you can skip stations and keep the raw cohort.',
  ...
  },
  {
    ...
    section: 'Analysis',
    title: '1. Filtering',
    body: 'Optional: open <strong>Add Filtering</strong> to add filter rules. With no rules, <strong>Preview data</strong> still shows the raw cohort. Use <strong>Apply &amp; Continue</strong> only when you have conditions to commit, then <strong>Edit filters</strong> to reopen.',
  ...
  },
  {
    ...
    body: 'Open <strong>Customize Preprocessing</strong> if you need to change rules. Default NA removal is already in effect. Use <strong>Preview data</strong> to inspect processed tables without applying changes; <strong>Apply &amp; Continue</strong> only when you edit the rules, then <strong>Edit preprocessing</strong> to reopen.',
  ...
  },
  {
    ...
    body: 'Optional: open <strong>Add Transformation</strong> to create derived columns. Use <strong>Preview data</strong> for counts where available, then <strong>Edit transformation</strong> to reopen. When Data Handling is done, choose <strong>Continue to Algorithm Selection</strong>.',
